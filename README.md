...
All experiments (baseline comparison, model size comparison, training ratio analysis) use four datasets: **TPC-H**, **TPC-DS**, **IMDB**, and **STATS**.

### Required Data Files
- **`queryPlans/`** (~1.69 GB) - Query plans of TPC-H, TPC-DS, IMDB, and STATS
...
```bash
# 1. Clone the repo
git clone https://github.com/LLM4QPR/LLM4QPR.git
cd LLM4QPR
...
# For training set size experiments:
bash experiment_scripts/run_training_ratio_analysis.sh
```
